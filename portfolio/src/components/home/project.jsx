  ...
  return (
    <section className="bg-[#000000] px-[80px] max-md:px-[40px] max-sm:px-[20px] py-[101px] max-md:py-[51px]">
      ...
      <div className="flex mt-[52px] max-lg:flex-wrap gap-[32px]">
        <div className="w-[400px] max-[670px]:w-full max-lg:w-[45%] max-lg:h-auto max-lg:pb-[50px] hover:scale-105 transition-all duration-300 relative h-[350px] max-[1150px]:h-[300px] bg-white rounded-[7px] px-[12px] py-[20px]">
        ...
        <div className="w-[400px] max-lg:pb-[50px] max-[670px]:w-full max-lg:w-[45%] max-lg:h-auto max-[1150px]:h-[300px] hover:scale-105 transition-all duration-300 relative h-[350px] bg-white rounded-[7px] px-[12px] py-[20px]">
